...
const handleEvents=async(e)=>{
    ...
    const response=await fetch("http://https://royal-naan-curry-bar.onrender.com/api/v1/events/add-events",{
        method:"POST",
        headers: {
...
const markAsCompleted=async(id)=>{
    ...
    const response=await fetch("http://https://royal-naan-curry-bar.onrender.com/api/v1/events/mark-complete/"+id,{
        method:"PATCH",
        headers:{
            "Content-Type":"application/json",
            "Authorization":`Bearer ${token}`
...
useEffect(()=>{
    ...
    const fetchEvents=async()=>{
        ...
        const response=await fetch("http://https://royal-naan-curry-bar.onrender.com/api/v1/events/active-events",{
            method:"GET",
        })
