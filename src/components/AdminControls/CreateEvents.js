...
const handleEvents=async(e)=>{
    ...
    const response=await fetch(`${process.env.REACT_APP_BASE_URL}/api/v1/events/add-events`,{
        method:"POST",
        headers: {
...
const markAsCompleted=async(id)=>{
    ...
    const response=await fetch(`${process.env.REACT_APP_BASE_URL}/api/v1/events/mark-complete/`+id,{
        method:"PATCH",
        headers:{
            "Content-Type":"application/json",
            "Authorization":`Bearer ${token}`
