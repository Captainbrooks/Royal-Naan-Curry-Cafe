...
function ViewUsers() {
    ...
    const getAllUsers=async()=>{
        const response=await fetch("https://royal-naan-curry-bar.onrender.com/api/v1/user/get-users",{
            method:"GET",
            headers:{
    ...
    const makeAdmin=async(id)=>{
        ...
        try {
            const response=await fetch("https://royal-naan-curry-bar.onrender.com/api/v1/user/makeadmin/"+id,{
                method:"PATCH",
                headers:{
                    "Content-Type":"application/json",
                    "Authorization":`Bearer ${token}` 
...
const deleteUser=async(id)=>{
    ...
    try {
        const response=await fetch("https://royal-naan-curry-bar.onrender.com/api/v1/user/delete/"+id,{
            method:"DELETE",
            headers:{
                "Content-Type":"application/json",
                "Authorization":`Bearer ${token}` 
